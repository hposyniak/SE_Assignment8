...
public class Game {
	...
	int[] places = new int[6]; // where on board is the player 
	int[] purses = new int[6]; // gold coins players collect when they correctly answer a question 
	boolean[] inPenaltyBox = new boolean[6]; // checks if player is in a penalty box, assumes there are only 6 players
